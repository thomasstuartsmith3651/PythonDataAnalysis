...
for i in diff:
    if i > 6000:
        difff.append(i)
difff = np.array(difff)
meanWavelength = difff.mean()*2*3.791*10**-11
uncWavelength = difff.std()/np.sqrt(len(difff))*2*3.791*10**-11
print('meanWavelength =', meanWavelength, '+-', uncWavelength)
...
plt.savefig('crossingpointsgreen.png')
